...
const plans = [
  ...
  },
  {
    ...
    annual:  { usd: 9.56,  ngn: 7350,  gbp: 6.84  },
  ...
  },
  {
    ...
    annual:  { usd: 36.75, ngn: 28266, gbp: 26.29 },
...
export default function WordPressHostingPage() {
  ...
  return (
    <main className="page-shell hosting-page hosting-wordpress-page">
      {/* ── 1. Hero ─────────────────────────────────────────── */}
        ...
        <div className="shell">
          <Fade inView inViewOnce className="wp-hero__inner">
            ...
            <div className="hero-actions">
              <a
                href={buildCartAddUrl((plans.find((plan) => plan.featured) ?? plans[0]).pid, billing, currency)}
      ...
      <section className="homepage-section" id="plans">
        <div className="shell">
          ...
          <BillingToggle billing={billing} onChange={setBilling} savingsText="Save up to 30% · +2 months free" />
