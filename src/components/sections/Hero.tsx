...
const AVATARS = [
  { src: "/assets/proof/ada.jpg", alt: "Ada", name: "Ada", role: "Entrepreneur" },
  { src: "/assets/proof/emeka.jpg", alt: "Emeka", name: "Emeka", role: "Business Owner" },
  { src: "/assets/proof/seun.jpg", alt: "Seun", name: "Seun", role: "Freelancer" },
];
